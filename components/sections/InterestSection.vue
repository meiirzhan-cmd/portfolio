    ...
    <div class="container-custom">
      ...
      <div class="space-y-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <SectionTransition
            v-for="(category, index) in translatedInterests"
            :key="index"
            :delay="index * 100"
          >
            <div
            ...
            >
              ...
              <div class="interest-animation-container">
                ...
                <!-- Hover overlay -->
                <div
                  class="absolute inset-0 bg-blue-600/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                ></div>
              </div>
              ...
              <div class="p-5">
                ...
                <p class="text-neutral-400 text-sm interest-description">
